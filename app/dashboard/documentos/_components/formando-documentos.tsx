        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 hover:border-teal-200 transition-all hover:shadow-sm">
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-0.5 min-w-0">
                    ...
                    <span
                        className={cn("text-sm font-semibold", cfg.textClass)}
                    >
                        {cfg.label}
                    </span>
                </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                {onUploadThing && (
                    ...
                    >
                        ...
                        {doc.status === "em falta"
                            ? "Enviar com UploadThing"
                            : "Substituir via UploadThing"}
                    </button>
                )}
            </div>
        </div>
...
export function FormandoDocumentos({
    ...
    async function handleUploadThingComplete(
        url: string,
        nome: string,
        tamanho: number,
    ) {
            ...
            <div className="flex items-start justify-between">
                <div>
                    ...
                    <p className="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                        Mantém a tua documentação em dia para evitar suspensões
                    </p>
                </div>
                <div className="flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2 shadow-sm">
                    ...
                    <span className="text-sm font-bold text-gray-900 dark:text-gray-100">
                        {docs.length - emFalta}/{docs.length}
                    </span>
                ...
                <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-4 py-3">
                    ...
                    <p className="text-sm text-red-700">
                        ...
                        {emFalta > 0 && (
                            <>
                                <span className="font-semibold">
                                    {emFalta} documento{emFalta > 1 ? "s" : ""}{" "}
                                    em falta
                                </span>
                                . Por favor, envia os teus documentos para
                                regularizar a tua situação académica.
                            </>
                        )}
                    </p>
                </div>
