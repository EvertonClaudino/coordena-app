            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                        {isEditMode
                            ? "Edite as suas informações de conta"
                            : "Veja as suas informações de conta"}
                    </p>
                </div>
                {!isEditMode && (
                    <Button
                ...
                <div className="grid gap-6">
                    ...
                    {isEditMode && (
                        <div className="grid gap-6 pt-4 border-t border-gray-100 dark:border-gray-800 mt-2">
                            <h3 className="text-sm font-bold text-gray-900 dark:text-gray-100 border-l-4 border-teal-500 pl-3">
